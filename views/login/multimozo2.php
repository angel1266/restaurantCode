...
<div id="wrapper-2">
    <div class="row auth-wrapper gx-0">
        <div class="col-lg-7 col-xl-8 bg-primary auth-box-2 on-sidebar hidden-md-down" style="background-image:url(<?php echo URL; ?>public/images/background/bg.jpg); background-size: cover;">
            <div class="h-100 d-flex align-items-center justify-content-center">
                <div class="row justify-content-center text-center">
                    <div class="col-md-7 col-lg-12 col-xl-9">
                        <a href="javascript:void(0)" class="text-center db"><img class="logo" src="<?php echo URL; ?>public/images/logo-facperu.png" width='30%' /></a>
                        <h2 class="text-white mt-4 fw-light">FACPERU <span class="font-weight-medium text-warning">.REST</span></h2>
                        <h5 class="ocult text-white mt-0 fw-light">Ver 2.3</h5>
        ...
        <div class="col-md-12 col-lg-5 col-xl-4 d-flex align-items-center justify-content-center">
            <div class="row justify-content-center w-100 mt-1 mt-lg-0 px-5">
                <div class="col-12">
                    <div class="">
                        <!--<img src="<?php echo URL; ?>public/images/logo-facperu.png" style="width: 40%;max-width: 350px;margin: 0 auto;display: block;" class="mb-2"/>-->
