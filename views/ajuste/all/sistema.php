			                        ...
			                        <div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 letNumMayMin">
			                                    ...
			                                    <span class="bar"></span>
			                                    <label for="di_acr">Nomenclatura <span class="label label-info font-13">EJEMPLO: CI, DNI, RG</span></label>
			                                </div>
			                            </div>
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 ent">
			                        ...
			                        <div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40 letNumMayMin">
			                                    ...
			                                    <span class="bar"></span>
			                                    <label for="imp_acr">Nomenclatura <span class="label label-info font-13">EJEMPLO: IVA, IGV</span></label>
			                                </div>
			                            </div>
			                            <div class="col-md-6">
			                        ...
			                        <div class="row">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
			                                    ...
			                                    <span class="bar"></span>
			                                    <label for="mon_acr">Nomenclatura <span class="label label-info font-13">EJEMPLO: DOLARES, PESOS.</span></label>
			                                </div>
			                            </div>
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
