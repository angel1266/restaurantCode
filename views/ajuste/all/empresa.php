    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body sunat b-t">
                <div class="m-t-20">
                    <h4 class="card-title">Facturaci&oacute;n electr&oacute;nica (SRI)</h4>
                    <h6 class="card-subtitle">Informaci&oacute;n SRI</h6>
                    <div class="row">
                                ...
                                <table class="table table-condensed table-hover" width="100%">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-t-5 m-b-0">Conectar con SRI</h5><h6 class="text-muted">Activar la conexi&oacute;n con SRI.</h6>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-t-5 m-b-0">Producci&oacute;n *</h5><h6 class="text-muted">Empezar a enviar los documentos a SRI.</h6>
