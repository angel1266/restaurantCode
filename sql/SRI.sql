...
--
-- Host: localhost    Database: facperurest
-- ------------------------------------------------------
...
INSERT INTO `tm_area_prod` (`id_areap`, `id_imp`, `nombre`, `estado`) VALUES (1,2,'COCINA','a'),(2,3,'BAR','a');
...
INSERT INTO `tm_configuracion` (`id_cfg`, `zona_hora`, `trib_acr`, `trib_car`, `di_acr`, `di_car`, `imp_acr`, `imp_val`, `mon_acr`, `mon_val`, `pc_name`, `pc_ip`, `print_com`, `print_pre`, `print_cpe`, `opc_01`, `opc_02`, `opc_03`, `bloqueo`, `cod_seg`) VALUES (1,'America/Bogota','RUC',13,'CI',11,'IVA',12.00,'DOLARES','$','JoeKio','192.168.1.30',1,1,0,0,0,1,NULL,'123456');
...
INSERT INTO `tm_empresa` (`id_de`, `ruc`, `razon_social`, `nombre_comercial`, `direccion_comercial`, `direccion_fiscal`, `ubigeo`, `departamento`, `provincia`, `distrito`, `sunat`, `modo`, `usuariosol`, `clavesol`, `clavecertificado`, `client_id`, `client_secret`, `logo`, `celular`, `email`) VALUES (1,'10490678404','MEZAHUAMÁN PADILLA JOE EVANS','RESTOBAR','JR. NEMESIO RAEZ NRO. 435, JUNIN - HUANCAYO - HUANCAYO','JR. NEMESIO RAEZ NRO. 435, JUNIN - HUANCAYO - HUANCAYO','150132','JUNIN','HUANCAYO','HUANCAYO', 1, 1, 'MODDATOS', 'moddatos', '123456', '', '', '', '999991600', '');
...
INSERT INTO `tm_mesa` (`id_mesa`, `id_salon`, `nro_mesa`, `estado`) VALUES (1,1,'01','a'),(2,1,'02','a'),(3,1,'03','a');
...
INSERT INTO `tm_tipo_doc` (`id_tipo_doc`, `descripcion`, `serie`, `numero`, `estado`) VALUES (1,'BOLETA DE VENTA','B001','00000001','i'),(2,'FACTURA','0001','00000001','a'),(3,'NOTA DE VENTA','NV01','00000001','a');
...
INSERT INTO `tm_tipo_gasto` (`id_tipo_gasto`, `descripcion`) VALUES (1,'POR COMPRAS'),(2,'POR SERVICIOS'),(3,'POR REMUNERACION'),(4,'POR CREDITO DE COMPRAS');
...
INSERT INTO `tm_usuario` (`id_usu`, `id_rol`, `id_areap`, `dni`, `ape_paterno`, `ape_materno`, `nombres`, `email`, `usuario`, `contrasena`, `estado`, `imagen`) VALUES (1,1,0,'49067840','MEZAHUAMAN','PADILLA','JOE EVANS','admin@facperu.com','administrador','c3VwZXJhZG1pbg==','a','161117020710-avatar5.png');
...
--
-- Dumping events for database 'facperurest_chakreros'
--

--
-- Dumping routines for database 'facperurest_chakreros'
--
