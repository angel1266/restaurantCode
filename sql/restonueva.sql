...
INSERT INTO `tm_configuracion` (`id_cfg`, `zona_hora`, `trib_acr`, `trib_car`, `di_acr`, `di_car`, `imp_acr`, `imp_val`, `mon_acr`, `mon_val`, `pc_name`, `pc_ip`, `print_com`, `print_pre`, `print_cpe`, `opc_01`, `opc_02`, `opc_03`, `bloqueo`, `cod_seg`) VALUES (1,'America/Lima','RUC',11,'DNI',8,'IGV',10.00,'Soles','S/','JoeKio','192.168.1.30',1,1,0,0,0,1,NULL,'123456');
...
INSERT INTO `tm_tipo_doc` (`id_tipo_doc`, `descripcion`, `serie`, `numero`, `estado`) VALUES (1,'BOLETA DE VENTA','B001','00000001','a'),(2,'FACTURA','F001','00000001','a'),(3,'NOTA DE VENTA','NV01','00000001','a');
